...
\begin{DoxyParams}{Parameters}
{\em gl} & Q\+Open\+G\+L\+Functions which can be used by \hyperlink{class_scene_renderer}{Scene\+Renderer} to release G\+P\+U resources \\
\hline
\end{DoxyParams}
...
\hline
{\em shader\+Programs} & A \hyperlink{singleton_q_hash}{Q\+Hash} containing different shader programs for different components of scene (lightrays and gems) \\
\hline
\end{DoxyParams}

...
Override \hyperlink{class_abstract_gem_ab4f3c6d38acbe59a610c67588e4944d7}{Abstract\+Gem\+::process\+Ray\+Intersection()} in order to ensure the player looses hitting the bounds. 
...
Returns a \hyperlink{class_q_list}{Q\+List} containing only a \hyperlink{class_game_lost_ray}{Game\+Lost\+Ray}, so the player will loose as soon as the player tries to move on returned ray. 
\end{DoxyReturn}

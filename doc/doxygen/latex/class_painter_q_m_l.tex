...
Cleans up the rendering thread ressources.  This slot is also connected by \hyperlink{class_painter_q_m_l}{Painter\+Q\+M\+L} to corresponding signal of Q\+Quick\+Item. 
...
Checks if the \hyperlink{class_painter_q_m_l}{Painter\+Q\+M\+L} assumes the app is active or not. 
...
Reloads environment map of game using \hyperlink{class_config}{Config}. 
...
Sets the scene which should be drawn by \hyperlink{class_painter_q_m_l}{Painter\+Q\+M\+L}. 
...
Synchronizes game logic and rendering.  Because Q\+M\+L uses different threads for ui and rendering, synchronization between these threads has to be done. This slot is connected by \hyperlink{class_painter_q_m_l}{Painter\+Q\+M\+L} to corresponding signals of Q\+Quick\+Item. 

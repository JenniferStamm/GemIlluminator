...
Adds a new \hyperlink{class_light_ray}{Light\+Ray} that will be rendered.  Dynamic Light\+Rays are added without checking whether they exist or not. Static Light\+Rays will be only added if the \hyperlink{class_light_ray}{Light\+Ray} is not already drawn by \hyperlink{class_light_ray_renderer}{Light\+Ray\+Renderer}. 

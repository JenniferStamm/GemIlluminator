...
const bool drawPackedGemsWithUiforms = true;
...
void packedGemsWithUniforms()
{
    ...
    vec3 worldCoord = a_vertex;
    worldCoord *= u_xyzs[index].w;
    worldCoord = rotateVector(u_rotation[index], worldCoord);
    worldCoord += u_xyzs[index].xyz;
